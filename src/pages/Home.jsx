  ...
  return (
    <main className="font-sans">
      ...
      <section id="about" className="max-w-5xl mx-auto text-center py-20 px-6">
        ...
        <div className="relative p-1 rounded-3xl bg-gradient-to-r from-blue-400 via-yellow-400 to-pink-400 animate-gradient-x">
      ...
      <section id="strengths" className="py-20 px-6 text-center bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {/* Vision */}
          <div className="p-1 rounded-3xl bg-gradient-to-r from-purple-400 via-pink-400 to-yellow-400 animate-gradient-x">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition duration-300">
              <div className="text-4xl mb-3 text-blue-600 inline-block"><TbBuildingCommunity /></div>
          ...
          {/* Mission */}
          <div className="p-1 rounded-3xl bg-gradient-to-r from-green-400 via-blue-400 to-purple-400 animate-gradient-x">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition duration-300">
              <div className="text-4xl mb-3 text-blue-600 inline-block"><TbTools /></div>
          ...
          {/* Core Values */}
          <div className="p-1 rounded-3xl bg-gradient-to-r from-pink-400 via-yellow-400 to-green-400 animate-gradient-x">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition duration-300">
              <div className="text-4xl mb-3 text-blue-600 inline-block"><FaAward /></div>
      ...
      <section id="services" className="bg-gray-100 py-20 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="service-card p-1 rounded-3xl bg-gradient-to-r from-blue-400 via-yellow-400 to-pink-400 animate-gradient-x">
          ...
          <div className="service-card p-1 rounded-3xl bg-gradient-to-r from-purple-400 via-pink-400 to-yellow-400 animate-gradient-x">
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition duration-300">
          ...
          <div className="service-card p-1 rounded-3xl bg-gradient-to-r from-green-400 via-blue-400 to-purple-400 animate-gradient-x">
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition duration-300">
